...
if (!updater.pubkey || updater.pubkey.length !== 44) {
  console.error('❌ Error de Configuración: La clave pública "pubkey" del updater debe tener exactamente 44 caracteres base64.');
  process.exit(1);
}
